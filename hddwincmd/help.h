...
--disk [path] (or --d) - disk path (deviceID / devicePath / volume GUID / drive letter / physical drive number / folder path)
    examples:
    ...
    commentary:
     ...
     The disk can be specified via a folder/file path containing mount points and symbolic links.
